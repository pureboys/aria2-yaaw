...
# goreman setup
RUN echo "web: gosu dummy /bin/busybox httpd -f -p 8080 -h /yaaw\nbackend: gosu dummy /usr/bin/aria2c --enable-rpc --rpc-listen-all --rpc-allow-origin-all --dir=/data" > Procfile
